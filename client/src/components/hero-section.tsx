  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1556761175-4b46a572b786?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80')" }}
      ></div>
      ...
      <div className="container-custom relative z-10">
        <div className={`max-w-4xl animated-element ${isInView ? 'in-view' : ''}`}>
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl leading-tight font-bold mb-6">
            Transform Your Workforce with Expert-Led Training
          </h1>
          <p className="text-xl md:text-2xl text-neutral-200 mb-8 max-w-2xl">
            Develop high-performing teams through our comprehensive training programs tailored to your organization's unique needs.
          </p>
